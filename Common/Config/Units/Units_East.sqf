...
_c = _c + ['rhs_msv_strelok_rpg_assist'];
_p = _p + [''];
_n = _n + [''];
_o = _o + [150];
_t = _t + [5];
...
_c = _c + ['rhs_msv_machinegunner_assistant'];
_p = _p + [''];
_n = _n + [''];
_o = _o + [65];
_t = _t + [5];
...
_u = _u + [0];
_f = _f + [CTI_FACTORY_REPAIR];
_s = _s + [["RHS_Ural_MSV_01","salvager"]];
...
_c = _c + ['RHS_Mi24V_AT_vvsc'];
_p = _p + [''];
_n = _n + ['Mi-24V (2xAT/FFAR)'];
_o = _o + [40000];
_t = _t + [30];
_u = _u + [1];
_f = _f + [CTI_FACTORY_AIR];
