...
_c = _c + ['rhsusf_army_ocp_machinegunnera'];
_p = _p + [''];
_n = _n + [''];
_o = _o + [65];
_t = _t + [5];
...
_c = _c + ['rhsusf_rg33_wd'];
_p = _p + [''];
_n = _n + ['RG 33 Woodland'];
_o = _o + [475];
_t = _t + [20];
_u = _u + [0];
_f = _f + [CTI_FACTORY_LIGHT];
...
_p = _p + [''];
_n = _n + ["M1A2 SEP1 TUSKI Woodland"];
_o = _o + [16000];
_t = _t + [30];
_u = _u + [2];
_f = _f + [CTI_FACTORY_HEAVY];
...
_c = _c + ['rhs_ah1z_wd'];
_p = _p + [''];
_n = _n + ['AH-1Z (Multi-Role) Woodland'];
_o = _o + [35000];
_t = _t + [35];
_u = _u + [1];
_f = _f + [CTI_FACTORY_AIR];
...
_p = _p + [''];
_n = _n + ['AH-1Z (Ground-Suppression) Woodland'];
_o = _o + [35000];
_t = _t + [35];
_u = _u + [1];
_f = _f + [CTI_FACTORY_AIR];
...
_p = _p + [''];
_n = _n + ['AH-1Z (Close-Support) Woodland'];
_o = _o + [35000];
_t = _t + [35];
_u = _u + [1];
_f = _f + [CTI_FACTORY_AIR];
...
_c = _c + ['rhs_uh1y'];
_p = _p + [''];
_n = _n + ['UH-1Y (FFAR/MG) Woodland'];
_o = _o + [12000];
_t = _t + [30];
_u = _u + [0];
_f = _f + [CTI_FACTORY_AIR];
_s = _s + [""];
//USAF PLANES @USAF MOD
...
_p = _p + [''];
_n = _n + ['Airlift Medical Container'];
_o = _o + [2000];
_t = _t + [25];
_u = _u + [0];
_f = _f + [CTI_FACTORY_AIR];
