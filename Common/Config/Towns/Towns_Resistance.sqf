with missionNamespace do {
	...
	GUER_SOLDIER_LAT = "rhs_g_Soldier_AT_F";
	GUER_SOLDIER_HAT = "rhs_g_Soldier_LAT_F";
	...
	GUER_VEHICLE_APC = ["rhs_btr70_chdkz", "rhs_bmd2_chdkz"]; //todo: replace with real veh later on
	...
	GUER_VEHICLE_ARMORED_LIGHT = ["rhs_zsu234_chdkz","rhs_bmd2_chdkz"];
